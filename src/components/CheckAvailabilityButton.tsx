  ...
  return (
    <>
      <button
        ...
        className="mt-6 flex w-fit items-center gap-6 rounded-full border border-almond bg-white py-2 pl-8 pr-2 shadow-sm transition-colors hover:border-pumpkin"
      >
        <span className="font-semibold text-coffee">Check Availability</span>
        <span className="flex size-16 shrink-0 items-center justify-center rounded-full bg-coffee text-white">
          <svg
